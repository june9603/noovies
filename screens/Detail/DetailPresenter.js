...
export default ({  openBrowser, result, loading }) => (
        // ScrollContainer에는 children 이 필요하므로 fragment 필요
        <ScrollContainer 
            loading={false} 
        ...
        > 
            <>
                ...
                <Data>
                    {result.overview ? (
                        // && 이 축약어 사용 시 false이면 {""} 이런 string 형식인데 이건 항상 Text 컴포넌트 안에 넣어줘야 함으로 여기에서는 if else 같은 ? 축약어를 사용해야한다
                        <>
